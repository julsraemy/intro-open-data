...
listing:
  ...
  contents:
    ...
    - title: "opendata.tpg"
      ...
      categories: [ogd]
    - title: "Open Data from Swiss Parliaments and Politics"
      path: https://openparldata.ch/
      description: >
        **Swiss Parliamentary OGD:** OpenParlData.ch provides free, harmonised open data from national, cantonal, and municipal Swiss parliaments—covering political actors, parliamentary proceedings, decrees, consultations, votes, and more from 78 parliaments. Data is published under CC BY 4.0, accessible via an API (currently in beta) and bulk [exports](https://files.openparldata.ch/exports/). The source code is publicly available and open to contributions.
      image: https://openparldata.ch/media/openParlData-D7XPKWIP.svg
      categories: [ogd]
    - title: "Open data platform mobility Switzerland"
      path: https://opentransportdata.swiss/en/
      description: >
      ...
      image: https://opentransportdata.swiss/wp-content/uploads/2016/11/e7b38b94159f1c674de50e68980e29e8479525e7.png
      categories: [ogd]
    - title: "European Data"
    ...
    - title: "opendata.ch"
      ...
      categories: [association]
    - title: "Open Research Data Unit"
      path: https://ord.akademien-schweiz.ch/
      description: >
      ...
      image: https://api.swiss-academies.ch/site/assets/files/116001/a_logo_academies_en_rgb.png
      categories: [association]
    - title: "GeoBeer"
      path: https://geobeer.ch/
      description: >
      ...
      image: https://geobeer.ch/assets/GeoBeer-logo.png
      categories: [association]
