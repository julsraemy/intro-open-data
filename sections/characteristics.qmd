...
&rarr; for more information, see @wielStakeholderEngagementSustainable2024
...
- DCAT Application Profile for Data Portals in Switzerland (DCAT-AP CH): [eCH-0200](https://ech.ch/fr/ech/ech-0200/)
...
::: {.column-page}
<iframe src="characteristics-slides.html" width="100%" height="600px" style="border: 1px solid #ccc; border-radius: 4px;"></iframe>
:::
