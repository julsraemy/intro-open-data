...
**Policy** – Since 2015, the European Union has conducted an annual assessment to gauge the progress of European countries in promoting and facilitating the availability and reuse of public sector information – predominantly open government data. This component investigates the open data policies and strategies in place, the national governance models for managing open data, and the measures implemented to execute these policies.

**Impact** – The assessment also examines the willingness, preparedness and capacity of countries to measure both the reuse of open data and the impact that this reuse creates.

### Portal and Quality

**Portal** – This element evaluates the functionality of national open data portals. It considers how well the portals cater to user needs, the methods used to assess user behaviour, the breadth of data available across different sectors, and the strategies in place to ensure the portals’ sustainability.

**Quality** – In this area, the evaluation focuses on the measures adopted by portal managers to systematically harvest metadata, monitor metadata quality and ensure compliance with the DCAT-AP metadata standard, as well as the quality of the data published on the national portals.
...
The 2023 ODM assessment involved 35 participating countries – including the EU-27, three European Free Trade Association countries (Iceland, Norway and Switzerland), and five candidate countries (Bosnia and Herzegovina, Montenegro, Albania, Serbia and Ukraine). Notably, Switzerland scored 79% in Open Data Maturity, ranking 24th among the participants [@page2023OpenData2023].

Further information is available in the [ODM 2023 report](https://data.europa.eu/en/publications/open-data-maturity/2023).

### ODM 2024

(...) [@page2024OpenData2024]

[ODM 2024 report](https://data.europa.eu/en/publications/open-data-maturity/2024)
