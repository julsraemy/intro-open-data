...
::: {.callout-note}
## Slide Presentation
Most of the following content can be found in presentation format: [Associated Movements and Principles (slides 89-161)](https://julsraemy.ch/prezi/intro-open-data-2024.html#89). Please note this is the 2024 version of the course and will not be kept updated.
:::

## FAIR Data Principles 

![FAIR guiding principles for data resources](https://upload.wikimedia.org/wikipedia/commons/a/aa/FAIR_data_principles.jpg)
...
![Be FAIR and CARE](https://images.squarespace-cdn.com/content/v1/5d3799de845604000199cd24/1567592451970-2R8XFL670QNMAGDRV7ED/Be+FAIR+and+CARE.png)
...
![Workflow to publish collections as data](https://julsraemy.ch/prezi/assets/cad-workflow.jpg)
...
![Data produced for a digisited historical newspaper](https://www.kbr.be/wp-content/uploads/2020/11/data-level-access-to-collections.png)
...
![5-star deployment scheme for Open Data](https://5stardata.info/images/5-star-steps.png)
...
![Tweaked Semantic Web Technology Layer Cake](https://julsraemy.ch/prezi/assets/tweaked-semweb-layer-cake.webp)
...
![IIIF Logo](https://julsraemy.ch/prezi/assets/IIIF-logo-500w.png)
...
![Linked Art Logo](https://julsraemy.ch/prezi/assets/Linked_Art_logo.png)
