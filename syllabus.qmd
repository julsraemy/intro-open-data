...
| Date 	| Content 	|
|------------	|----------------------------	|
| 18.02.2026 	| Course Overview, [Characteristics of Open Data](sections/characteristics.qmd), [Associated Movements](sections/movements.qmd), [Exercise 1](#exercise-1)	| 
| 25.02.2026 	| [Associated Principles](sections/principles.qmd), [Exercise 2](#exercise-2), [Open Data Platforms and Organisations](sections/platforms.qmd), [Exercise 3](#exercise-3)                 	|
| 04.03.2026 	| [Assessment, Data Quality, and Best Practices](sections/assessment.qmd), [Techniques, Software, and Tools](sections/techniques.qmd), [Exercise 4](#exercise-4)                  	|
| 11.03.2026 	| [Showcases](sections/showcases.qmd), Assignment Workshop                	| 
...
2. Developer-centric data accessibility
3. Unrestricted access to scholarly publications
4. Persistent identifier assignment
5. Digital object interoperability
6. Ethical data stewardship
7. Research transparency and reproducibility
...
5. Create a project by importing the data extract from the CAS photographic archives: `ekws_extract.csv` (which can be found on Cyberlearn)
...
- Between 900 and 1,100 words (excluding references) in either PDF or in `.qmd` if you would like it to be published on this website. Please refer to the [template](assignments/template.qmd).
- Short paper to be submitted either to the lecturer by email or via a pull request on the [GitHub repository](https://github.com/julsraemy/intro-open-data) by **Friday 14 March**.
