...
::: {.notes}
Open data has evolved from simple availability to sophisticated interconnected systems that maximize usability.
:::
...
::: {.notes}
GLAM institutions play a crucial role in both producing and utilizing open data for cultural heritage preservation and access.
:::
